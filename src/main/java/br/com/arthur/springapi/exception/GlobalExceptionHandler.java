package br.com.arthur.springapi.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException ex, final HttpHeaders headers, final HttpStatusCode status, final WebRequest request) {
    ...
    return new ResponseEntity<>(returnObject, null, HttpStatus.BAD_REQUEST);
  }
  ...
  public ResponseEntity<Object> handleAppException(final AppException ex) {
    ...
    returnObject.put("message", ex.getMessage());
     ...
     return new ResponseEntity<>(returnObject, null, ex.getStatusCode());
  ...
  public ResponseEntity<Object> handleInternal(final RuntimeException ex) {
    ...
    return new ResponseEntity<>(returnObject, null, HttpStatus.INTERNAL_SERVER_ERROR);
  }
